...
const Register: React.FC = () => {
    ...
    return (
        <IonPage style={{ backgroundImage: 'url("https://i.gifer.com/origin/a4/a4fb1ab272da13569b081edaea1b2586_w200.gif")', backgroundSize: 'cover', backgroundPosition: 'center', height: '100%' }}>
